...
export const strings = {
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'Custom API Settings',
    account: 'Settings',
    login: 'API Key Settings',
    loginGenspark: 'Configure API Key',
    loggedIn: 'API Key Configured',
    loggedInGenspark: 'Custom Provider Ready',
