...
function ApiSettingsModal({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    void window.aiOffice?.getAiSettings?.().then((settings: any) => {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        <h3 style={{ marginBottom: 16 }}>AI Provider Settings</h3>
    ...
    <div className="home">
      <aside className="sidebar">
        <div className="sidebar-logo">
          <img className="logo-lockup" src={logoLockup} alt="OpenOffice" />
        </div>
